 ...
 * and limitations under the License. ==================================================================== This software consists of voluntary contributions
 * made by many individuals on behalf of the Apache Software Foundation. For more information on the Apache Software Foundation, please see
 * <http://www.apache.org/>.This class is modified and exists as a support library due to the fact that android has a different version of httpclients library
 */
...
public class HttpClientURLEncodedUtils {
     ...
     */
    public static List<NameValuePair> parse(String query, final String encoding) {
     ...
     * <p>
     * This list is the same as the {@code reserved} list in <a href="http://www.ietf.org/rfc/rfc2396.txt">RFC 2396</a> as augmented by <a
    ...
    private static String decodeFormFields(final String content, final String charset) {
        ...
        return urldecode(content, charset != null ? Charset.forName(charset) : HttpClientConsts.UTF_8, true);
    }
    ...
    private static String decodeFormFields(final String content, final Charset charset) {
        ...
        return urldecode(content, charset != null ? charset : HttpClientConsts.UTF_8, true);
    }
    ...
    private static String encodeFormFields(final String content, final String charset) {
        ...
        return urlencode(content, charset != null ? Charset.forName(charset) : HttpClientConsts.UTF_8, URLENCODER, true);
    }
    ...
    private static String encodeFormFields(final String content, final Charset charset) {
        ...
        return urlencode(content, charset != null ? charset : HttpClientConsts.UTF_8, URLENCODER, true);
    }
