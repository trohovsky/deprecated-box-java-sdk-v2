...
public class CopyItemRequest extends DefaultBoxRequest {
     ...
     *             exception
     */
    public CopyItemRequest(final IBoxConfig config, final IBoxJSONParser parser, final String id,
        final BoxEntityRequestObject<BoxItemCopyRequestEntity> requestObject, final BoxResourceType type) throws BoxRestException {
